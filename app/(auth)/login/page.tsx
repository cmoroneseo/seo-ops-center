        ...
        <div className="flex min-h-screen flex-col items-center justify-center bg-background p-4">
            <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                    <h1 className="text-4xl font-bold tracking-tight neon-gradient-text mb-2">SEO OPS</h1>
                ...
                <div className="rounded-xl border border-border bg-card p-8 shadow-lg backdrop-blur-sm">
                    ...
                    <div className="mt-6 text-center text-sm text-muted-foreground space-y-4">
                        <Link href="#" className="block hover:text-primary underline underline-offset-4">
